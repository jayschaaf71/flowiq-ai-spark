  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Advanced analytics and insights across all tenants</p>
      </div>
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">Detailed usage analytics charts and insights will be displayed here.</p>
            </CardContent>
          </Card>
        </TabsContent>
