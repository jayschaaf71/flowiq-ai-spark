-- Clean up and create admin users for FlowIQ Pilot Practices
-- This script first removes any existing admin users, then creates fresh ones

-- First, let's clean up any existing admin users to avoid conflicts
