-- Check and Fix Admin Users for FlowIQ Pilot Practices
-- This script checks if admin users exist and recreates them if needed
...
SELECT '=== EXISTING PROFILES ===' as status;
...
SELECT '=== EXISTING TENANT USERS ===' as status;
SELECT tu.tenant_id, tu.user_id, tu.role, t.name as tenant_name 
...
-- Now let's clean up any existing users and recreate them properly
SELECT '=== CLEANING UP EXISTING USERS ===' as status;

-- Delete from tenant_users first (due to foreign key constraints)
