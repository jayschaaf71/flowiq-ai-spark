-- Fix admin users for FlowIQ Pilot Practices
-- This script uses ON CONFLICT to handle existing users gracefully
...
-- Create or update profiles for the admin users
...
-- Create some test providers for each practice (only if they don't exist)
